      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-r from-amber-800 via-amber-700 to-amber-900 rounded-3xl p-6 sm:p-10 text-white shadow-lg flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a 
            ...
            class="px-6 py-3.5 bg-white hover:bg-amber-50 text-amber-900 font-bold text-base rounded-xl shadow-md transition-transform active:scale-98 flex items-center gap-2 flex-shrink-0">
